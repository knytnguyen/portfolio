  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#152037] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/d4246a12-448e-4119-b6fa-4382a2c0ffbd" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4 border-[#9285C8] text-[#f0f4f8]'>Contact</p>
            ...
            <button className='text-[#f0f4f8] border-2 hover:bg-[#9285C8] hover:border-[#152037] px-4 py-3 my-8 mx-auto flex items-center' required>Send Message</button>
        </form>
    </div>
  )
}
