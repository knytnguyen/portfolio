        ...
        <form method='POST' action="https://getform.io/f/d4246a12-448e-4119-b6fa-4382a2c0ffbd" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                ...
                <p className='text-[#16192C] py-4'>For feedback or business inquiries, submit this form here or send me an email at: ‎  
                  <a className='bold underline text-[#B48EAD] hover:text-[#E6CCF5]' href="mailto: knytnguyen@gmail.com">knytnguyen@gmail.com</a>
                </p>
            </div>
            ...
            <textarea className='resize-none p-3 bg-[#FFF5B1] rounded-lg border-2 border-solid border-[#16192C]' name='message' rows='10' placeholder='Input your message here.'></textarea>
