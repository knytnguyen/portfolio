...
const Home = () => {
  return (
    <div name='home' className='w-full h-screen bg-gradient-to-r from-[#1d3d52] to-[#4c4177]'>
        {/* CONTAINER */}
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <h2 className='text-4xl py-2 sm:text-7xl font-bold text-[#8892b0]'>an aspiring Software Engineer.</h2>
            <p className='text-2xl text-[#8892b0] py-2 max-w-[700px]'>Welcome to my first ever React project! I hope you enjoy the stay ^_^</p>
            <div>
                <button className='text-[#f0f4f8] group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#ff79c6] hover:border-[#121212]'>
