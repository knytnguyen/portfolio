  ...
  return (
    <div name='skills' className='w-full h-screen bg-[#FDFAF2] text-[#16192C]'>
        ...
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
            <div>
                <p className='text-4xl font-bold inline border-b-4 border-[#E6CCF5]'>Skills & Resume</p>
            ...
            <div className='w-full grid grid-cols-2 sm:grid-cols-3 gap-4 text-center py-8 pb-10'>
                ...
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-[#FFF5B1]'>
                    <img src={Python} alt="C++ Icon" className='w-20 mx-auto pt-2'/>
                    <p className='my-4'>Python</p>
                </div>
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-[#FFF5B1]'>
                    <img src={JavaScript} alt="C++ Icon" className='w-20 mx-auto pt-1'/>
                    <p className='my-4'>JavaScript</p>
                </div>
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-[#FFF5B1]'>
                    <img src={GitHub} alt="C++ Icon" className='w-20 mx-auto pt-2'/>
                    <p className='my-4'>Git/GitHub</p>
                </div>
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-[#FFF5B1]'>
                    <img src={ReactLogo} alt="C++ Icon" className='w-20 mx-auto pt-2'/>
                    <p className='my-4'>React</p>
                </div>
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-[#FFF5B1]'>
                    <img src={HTML} alt="C++ Icon" className='w-20 mx-auto pt-4'/>
